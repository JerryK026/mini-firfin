...
/*
    TODO: index 후보군 : (created_date_time, sender_id, id, deleted), (created_date_time, sender_id), (created_date_time, id)
    판단 기준 및 경고사항
    ...
    - 만약 sender_id와 id를 함께 인덱스에 넣을 거면 sender_id를 먼저 넣어야 함.
      ...
      - (created_date_tiem, id)가 카디널리티 때문에 더 빠를 수도 있음
...
//        @Index(name = "idx__created_date_time__sender_id", columnList = "created_date_time, sender_id DESC"),
